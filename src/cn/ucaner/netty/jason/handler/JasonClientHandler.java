 ...
 * @projectName：Netty-X
 * @Package：cn.ucaner.netty.jason.handler
 * @Description： <p> JasonClientHandler </p>
 * @Author： - Jason
 * @CreatTime：2019/6/17 - 18:27
 * @Modify By：
 * @ModifyTime： 2019/6/17
 * @Modify marker：
 */
public class JasonClientHandler extends SimpleChannelInboundHandler<JasonMessage> {

    @Override
    protected void messageReceived(ChannelHandlerContext channelHandlerContext, JasonMessage jasonMessage) throws Exception {
        System.out.println(jasonMessage);
    }
}
